...
public class OrderRepository {
    ...
    public static final List<Product> productsOfSecondOrder = List.of(new Product(9L, "Overns", "Baby", 50));
    ...
    public static ArrayList<Order> findAll(){
        ...
        list.add(new Order(5L, "active", LocalDate.of(2021, 3, 14), LocalDate.now(), productsOfSecondOrder, customer2));
        list.add(new Order(6L, "active", LocalDate.of(2021, 3, 14), LocalDate.now(), productsOfSecondOrder, customer2));
